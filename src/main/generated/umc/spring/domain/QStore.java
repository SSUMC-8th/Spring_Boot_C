...
public class QStore extends EntityPathBase<Store> {
    ...
    public final EnumPath<umc.spring.domain.enums.FoodList> category = createEnum("category", umc.spring.domain.enums.FoodList.class);
    ...
    public final ListPath<StorePhoto, QStorePhoto> storePhotoList = this.<StorePhoto, QStorePhoto>createList("storePhotoList", StorePhoto.class, QStorePhoto.class, PathInits.DIRECT2);
