...
public class QTerms extends EntityPathBase<Terms> {
    ...
    public final ListPath<umc.spring.domain.mapping.MemberTerms, umc.spring.domain.mapping.QMemberTerms> memberTermsList = this.<umc.spring.domain.mapping.MemberTerms, umc.spring.domain.mapping.QMemberTerms>createList("memberTermsList", umc.spring.domain.mapping.MemberTerms.class, umc.spring.domain.mapping.QMemberTerms.class, PathInits.DIRECT2);
