...
public class QMember extends EntityPathBase<Member> {
    ...
    public final ListPath<umc.spring.domain.mapping.MemberTerms, umc.spring.domain.mapping.QMemberTerms> memberAgreeList = this.<umc.spring.domain.mapping.MemberTerms, umc.spring.domain.mapping.QMemberTerms>createList("memberAgreeList", umc.spring.domain.mapping.MemberTerms.class, umc.spring.domain.mapping.QMemberTerms.class, PathInits.DIRECT2);

    public final ListPath<umc.spring.domain.mapping.MemberFood, umc.spring.domain.mapping.QMemberFood> memberFoodList = this.<umc.spring.domain.mapping.MemberFood, umc.spring.domain.mapping.QMemberFood>createList("memberFoodList", umc.spring.domain.mapping.MemberFood.class, umc.spring.domain.mapping.QMemberFood.class, PathInits.DIRECT2);
